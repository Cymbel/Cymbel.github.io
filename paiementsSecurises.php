	...
	<body>         
        ...
        <main>
            <div class="wrapperEntete">
                ...
                <ul class="accordion"> 
                    <li>
                        <a>Vos paiements sur le site sont 100% sécurisés.</a>
                        <p>The Somerset Cider Brandy Company ne conserve aucunes de vos informations de paiement. Vos paiement sont gérés directement par notre banque partenaire, ou Paypal selon le mode de paiement choisi.<br><br>
                        La transmission de vos données bancaires au moment du paiement par carte est complètement sécurisée, et vos données sont chiffrées grâce au protocole SSL (Secure Socket Layer).</p>
                    </li>
